...
1) Всех книжки, у которых больше 50 тысяч просмотров, возрастной лимит которых больше 14 и авторы которых начинаются с буквы "Д". Вывод произведи отсортировав по длине аннотации.
